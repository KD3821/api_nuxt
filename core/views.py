...
class PostViewSet(viewsets.ModelViewSet):
    ...
    # search_fields = ['$content', '$h1']  # поиск отдает результаты с любым регистром - перепроверить
...
class FeedBackView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer_class.is_valid():
            ...
            send_mail(f'От {name} | {subject}', message, from_email, ['to_some_email@someservice.com'])
